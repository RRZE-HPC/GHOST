...
void hybrid_kernel_VI(int current_iteration, VECTOR_TYPE* res, LCRP_TYPE* lcrp, VECTOR_TYPE* invec){

   /*****************************************************************************
    ********                  Kernel ir -- cs -- wa -- ca                ********   
    ********          Kommunikation mittels MPI_ISend, MPI_IRecv         ********
    ********       Umkopieren in innerer Schleife bedingt omp parallel   ********
    ****************************************************************************/
...
#pragma omp for 
  ...
  spmvmKernAll( lcrp, invec, res, &asm_cyclecounter, &asm_cycles, &cycles4measurement,
   ...
   IF_DEBUG(1){
      ...
      printf("HyK_VI: PE %d: It %d: Absetzen IRecv [ms]               : %8.3f\n",
	    me, current_iteration, 1000*time_it_took);

      time_it_took = (1.0*cs_cycles)/clockfreq;
      printf("HyK_VI: PE %d: It %d: Umkopieren & Kommunikation [ms]   : %8.3f",
	    me, current_iteration, 1000*time_it_took);
      ...
      printf("HyK_VI: PE %d: It %d: MPI_Waitall [ms]                  : %8.3f\n",
	    me, current_iteration, 1000*time_it_took);

      time_it_took = (1.0*ca_cycles)/clockfreq;
      printf("HyK_VI: PE %d: It %d: SpMVM (alle Elemente) [ms]        : %8.3f",
	    me, current_iteration, 1000*time_it_took);
      ...
      printf("HyK_VI: PE %d: It %d: Kompletter Hybrid-kernel [ms]     : %8.3f\n", 
