...
#define GHOST_SPMV_AUG_FLAGS                                                                       \
    (GHOST_SPMV_SHIFT | GHOST_SPMV_VSHIFT | GHOST_SPMV_SCALE | GHOST_SPMV_AXPY | GHOST_SPMV_AXPBY  \
 ...
 */
#define GHOST_SPMV_MODES_FULL                                                                      \
    (GHOST_SPMV_MODE_NOMPI | GHOST_SPMV_MODE_VECTOR | GHOST_SPMV_MODE_PIPELINED)
/**
...
#define GHOST_SPMV_MODES_MPI                                                                       \
    (GHOST_SPMV_MODE_VECTOR | GHOST_SPMV_MODES_SPLIT | GHOST_SPMV_MODE_PIPELINED)
 ...
 */
inline ghost_spmv_flags operator|(const ghost_spmv_flags &a, const ghost_spmv_flags &b)
{
    return static_cast<ghost_spmv_flags>(static_cast<int>(a) | static_cast<int>(b));
}
...
inline bool ghost_spmvflags_isset(const ghost_spmv_flags a, const ghost_spmv_flags b)
{
    return a && b;
}

inline ghost_spmv_flags ghost_spmvflags_enable(ghost_spmv_flags a, ghost_spmv_flags b)
{

    return (ghost_spmv_flags)((int)a | (int)b);
}
inline ghost_spmv_flags ghost_spmvflags_disable(ghost_spmv_flags a, ghost_spmv_flags b)
{
    return (ghost_spmv_flags)((int)a & ~(int)b);
}
