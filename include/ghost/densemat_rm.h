...
extern "C" {
    ...
    ghost_error ghost_densemat_rm_permute_selector(ghost_densemat *vec, ghost_context *ctx, ghost_permutation_direction dir);
    ...
    ghost_error ghost_densemat_rm_cloneVector(ghost_densemat *src, ghost_densemat **dst, ghost_lidx nr, ghost_lidx roffs, ghost_lidx nc, ghost_lidx coffs);
