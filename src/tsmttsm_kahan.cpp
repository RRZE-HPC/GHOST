...
#include "tsmttsm_kahan.def"
    ...
    ghost_gemm_perf_args_t tsmttsm_kahan_perfargs;
    tsmttsm_kahan_perfargs.n = w->traits.ncols;
    tsmttsm_kahan_perfargs.m = v->traits.ncols;
    if (v->context) {
        tsmttsm_kahan_perfargs.k = v->context->gnrows;
    } else {
        tsmttsm_kahan_perfargs.k = v->traits.nrows;
    }
    tsmttsm_kahan_perfargs.dt = x->traits.datatype;
    tsmttsm_kahan_perfargs.betaiszero = ghost_iszero(beta,p.dt);
    tsmttsm_kahan_perfargs.alphaisone = ghost_isone(alpha,p.dt);
    ghost_timing_set_perfFunc(__ghost_functag,ghost_gemm_perf_GBs,(void *)&tsmttsm_kahan_perfargs,sizeof(tsmttsm_kahan_perfargs),"GB/s");
    ghost_timing_set_perfFunc(__ghost_functag,ghost_gemm_perf_GFs,(void *)&tsmttsm_kahan_perfargs,sizeof(tsmttsm_kahan_perfargs),"GF/s");
#endif
