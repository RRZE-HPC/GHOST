...
#GHOST_FUNC_BEGIN#CHUNKHEIGHT=16,32
ghost_error_t dd_SELL_kernel_MIC_CHUNKHEIGHT(ghost_sparsemat_t *mat, ghost_densemat_t* res, ghost_densemat_t* invec, ghost_spmv_flags_t spmvmOptions,va_list argp)
{
    UNUSED(argp);
...
#pragma omp parallel for schedule(runtime) private(j,idx,val,rhs,offs)
