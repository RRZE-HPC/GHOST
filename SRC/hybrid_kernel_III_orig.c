...
/* solche Schleifen sind nicht kollabierbar */
...
#pragma omp parallel for schedule(runtime) private (hlp1, j)
  ...
  IF_DEBUG(1){
    ...
    printf("HyK_III: PE %d: It %d: Umkopieren [ms]                   : %8.3f",
    ...
    printf("HyK_III: PE %d: It %d: Kommunikation [ms]                : %8.3f",
	   me, current_iteration, 1000*time_it_took);
    ...
    printf("HyK_III: PE %d: It %d: SpMVM (alle Elemente) [ms]        : %8.3f",
	  me, current_iteration, 1000*time_it_took);
