...
void hybrid_kernel_I(int current_iteration, VECTOR_TYPE* res, LCRP_TYPE* lcrp, VECTOR_TYPE* invec){


   /*****************************************************************************
    ********                 Kernel cp -- co -- ca                       ********   
    ********          Kommunikation mittels MPI_Sendrecv                 ********
    ********                 serielles Umkopieren                        ********
    ****************************************************************************/
  ...
  IF_DEBUG(1){
    ...
    printf("HyK_I: PE %d: It %d: Umkopieren [ms]                   : %8.3f",
    ...
    printf("HyK_I: PE %d: It %d: Kommunikation [ms]                : %8.3f",
	   me, current_iteration, 1000*time_it_took);
