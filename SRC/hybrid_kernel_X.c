...
void hybrid_kernel_X(int current_iteration, VECTOR_TYPE* res, LCRP_TYPE* lcrp, VECTOR_TYPE* invec){
   ...
   IF_DEBUG(1){
      ...
      printf("HyK_X: PE %d: It %d: Absetzen des Irecv [ms]           : %8.3f",
      ...
      printf("HyK_X: PE %d: It %d: Umkopieren & Absetzen ISend [ms]  : %8.3f",
	    me, current_iteration, 1000*time_it_took);
      ...
      printf("HyK_X: PE %d: It %d: MPI_Waitall                 [ms]  : %8.3f",
	    me, current_iteration, 1000*time_it_took);
      printf(" Datenvolumen: %6.3f MB (@%6.3f GB/s) Nachrichten: %d\n", 
	    8e-6*hlp_sent, 8e-9*hlp_sent/time_it_took, send_messages );

      time_it_took = (1.0*lc_cycles)/clockfreq;
      printf("HyK_X: PE %d: It %d: SpMVM (lokale Elemente) [ms]      : %8.3f",
	    me, current_iteration, 1000*time_it_took);
      ...
      printf("HyK_X: PE %d: It %d: SpMVM (nichtlokale Elemente) [ms] : %8.3f",
	    me, current_iteration, 1000*time_it_took);
