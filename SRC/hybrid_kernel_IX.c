...
void hybrid_kernel_IX(int current_iteration, VECTOR_TYPE* res, LCRP_TYPE* lcrp, VECTOR_TYPE* invec){

	/*****************************************************************************
	 ********              Kernel ir -- cs -- wa -- lc -- nl              ********
	 ********         Kein Ueberlapp von Rechnung und Kommunikation       ********
	 ********     - Kosten der Aufspaltung in lokale und nichtlokale      ********
	 ********       Elemente fuer SpMVM abschaetzen                       ********
	...
	IF_DEBUG(1){
		...
		printf("HyK_IX: PE %d: It %d: Absetzen des Irecv [ms]           : %8.3f",
		...
		printf("HyK_IX: PE %d: It %d: Umkopieren & Absetzen ISend [ms]  : %8.3f",
				me, current_iteration, 1000*time_it_took);
		...
		printf("HyK_IX: PE %d: It %d: MPI_Waitall                 [ms]  : %8.3f",
				me, current_iteration, 1000*time_it_took);
		printf(" Datenvolumen: %6.3f MB (@%6.3f GB/s) Nachrichten: %d\n", 
				8e-6*hlp_sent, 8e-9*hlp_sent/time_it_took, send_messages );

		time_it_took = (1.0*lc_cycles)/clockfreq;
		printf("HyK_IX: PE %d: It %d: SpMVM (lokale Elemente) [ms]      : %8.3f",
				me, current_iteration, 1000*time_it_took);
		...
		printf("HyK_IX: PE %d: It %d: SpMVM (nichtlokale Elemente) [ms] : %8.3f",
				me, current_iteration, 1000*time_it_took);
		...
		printf("HyK_IX: PE %d: It %d: Kompletter Hybrid-kernel [ms]     : %8.3f\n", 
