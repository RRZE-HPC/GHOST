...
module load openmpi/1.4-intel64
...
set mymasks    = ( 502 261640 262142 5124 4 5120 ) # kernel selector: full_only split_only all 2,10,12 2 10,12
set mults      = "100"
set work_dist  = "1" # 1 approx eq NZE / 2 fancy NZE / else eq NRows
set thisexe    = "./HybridSpMVM_TUNE_SETUP_REVBUF_NLDD_CUDAKERNEL_TEXCACHE_PLACE_CYCLES_INT_gpu_OpenMPI.x"
