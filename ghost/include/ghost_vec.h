...
template <typename v_t> void ghost_vec_gaxpy_tmpl(ghost_vec_t *vec, ghost_vec_t *vec2, void *, void *);
...
void d_ghost_vec_gaxpy(ghost_vec_t *vec1, ghost_vec_t *vec2, void *, void *); 
void s_ghost_vec_gaxpy(ghost_vec_t *vec1, ghost_vec_t *vec2, void *, void *); 
void z_ghost_vec_gaxpy(ghost_vec_t *vec1, ghost_vec_t *vec2, void *, void *);
void c_ghost_vec_gaxpy(ghost_vec_t *vec1, ghost_vec_t *vec2, void *, void *);
